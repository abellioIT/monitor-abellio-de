...
async function parseSiteFormResponse(url) {
  try {
...
parseSiteFormResponse(url).then(data => {
  console.log(data);
  initPage()
});
...
// $.ajax({
//     // wenn man diese URL aufruft https://cms.abellio.de/api/pages/monitor/auskunft
//     // kommt völliger veralteter Unsinn. Ich habe keine Ahnung was die damit bezwecken wollen.
//     // url: "https://cms.abellio.de/api/pages/monitor/" + parameter,
//     url: "https://abrmd.siteforum.com/de/app/webtools/messages.widget?&design=0&navigation=0&action=overview&scheduled=0",
//     success: function (e) {
//         // initPage(JSON.parse(e.substring(1, e.length - 1)));
//         initPage(e)
//     },
//     error: function (e, i, a) {
//         console.log(e), console.log(i), console.log(a), setTimeout(reloadPage, 2000);
//     },
//     dataType: "text",
//     jsonp: "callback",
// });
